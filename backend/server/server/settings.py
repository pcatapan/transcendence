...
SECRET_KEY = 'django-insecure-z7=o^mjt^lu7%f9wy_(nfve_ar62#a67_%dj)(i%#=ss-doduq'
...
MIDDLEWARE = [
	...
	'api.middleware.JWTVerificationMiddleware'
]
...
# Definisco i path per il caricamento dei media
MEDIA_URL = '/media/'
